...
> **학습자를 위한 한국어 사전** | 3,874 SSG pages
>
...
| **Features** | 1900 entries, 24 categories, 53 conversations |
...
|:----|:---------------|:---------:|:------------|
| **Context** | 1900 entries + 24 categories + 53 conversations | 3,874 | JSON |
...
│
├── apps/                    # 3 applications
│   ├── context/             # Korean dictionary (3,874 SSG pages)
