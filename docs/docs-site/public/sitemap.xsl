...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="/">
    <html lang="en">
      <head>
        <title>XML Sitemap - SoundBlue Docs</title>
        ...
        <style>
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .lang-ja { background: rgba(236, 72, 153, 0.15); color: var(--lang-ja); }

          /* URL Groups for URL Set view */
          ...
          /* Section */
          .section-title { font-size: 1rem; font-weight: 600; margin: 1.5rem 0 1rem; padding-bottom: 0.5rem; border-bottom: 1px solid var(--border); color: var(--text); }
      ...
      <body>
        <div class="header">
          <div class="header-content">
            <div class="breadcrumb">
              <a href="/public-monorepo/">Home</a> › Sitemap
            </div>
            <h1>XML Sitemap</h1>
            ...
            <p class="meta-info">
              ...
              <xsl:choose>
                ...
                <xsl:otherwise>
                  <strong><xsl:value-of select="count(sitemap:urlset/sitemap:url[not(contains(sitemap:loc, '/ko/')) and not(contains(sitemap:loc, '/ja/'))])"/></strong> URL(s) with multilingual support (English, Korean &amp; Japanese).
                </xsl:otherwise>
              </xsl:choose>
        ...
        <div class="container">
                ...
                <table>
                  <thead>
                    <tr>
                      <th style="width: 5%">#</th>
                      <th>URL</th>
                      <th style="width: 25%">Translations</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="lang-tags">
                            ...
                            <xsl:if test="xhtml:link[@hreflang='ja']">
                              <a href="{xhtml:link[@hreflang='ja']/@href}" class="lang-tag lang-ja">JA</a>
                            </xsl:if>
                          </div>
                        </td>
                      </tr>
          ...
          <div class="footer">
            Generated by <a href="https://astro.build/" target="_blank" rel="noopener">Astro</a> ·
