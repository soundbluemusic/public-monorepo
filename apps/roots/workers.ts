 ...
 */
interface Env {
  /** 학문/참고자료 D1 데이터베이스 (knowledge) - 수학 개념, 라이브러리, API */
  KNOWLEDGE_DB: D1Database;
  /** 사용자 학습 진도용 프라이빗 D1 데이터베이스 (향후 구현 예정) */
