...
export const operationsResearchConcepts: MathConcept[] = [
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Mathematical analysis of waiting line systems. Modeling arrivals, service, waiting times',
        formulas: [
          'M/M/1: stable if λ < μ',
          'Utilization: ρ = λ/μ',
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Stochastic model for sequential decision making. States, actions, rewards, transitions',
        formulas: [
          '(S, A, P, R, γ)',
