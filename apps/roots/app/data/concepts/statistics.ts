...
export const statisticsConcepts: MathConcept[] = [
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Statistical method to test validity of hypotheses about population using sample data',
        formulas: [
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          '모수가 포함될 것으로 예상되는 값의 범위. 95% 신뢰구간은 반복 표본에서 95%가 참값 포함',
        formulas: [
      ...
      en: {
        definition:
          'Range of values expected to contain parameter. 95% CI means 95% of repeated samples contain true value',
        formulas: [
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Statistical method for modeling and predicting relationships between variables',
        formulas: [
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Method for testing mean differences among three or more groups. Compares between/within variance',
        formulas: [
          'F = MS_between / MS_within',
          'SS_total = SS_between + SS_within',
          'df_between = k-1, df_within = N-k',
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Non-parametric method for testing independence or goodness-of-fit of categorical data',
