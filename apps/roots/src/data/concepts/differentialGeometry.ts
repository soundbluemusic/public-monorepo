...
export const differentialGeometryConcepts: MathConcept[] = [
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['좌표계: (U, φ), φ: U → ℝⁿ', '전이함수: φ_β ∘ φ_α⁻¹', 'C^k 다양체: 전이함수가 k번 미분가능'],
      ...
      en: {
        ...
        formulas: ['Charts: (U, φ), φ: U → ℝⁿ', 'Transition: φ_β ∘ φ_α⁻¹', 'C^k manifold: transitions k-times differentiable'],
      ...
      ja: {
        ...
        formulas: ['座標系: (U, φ), φ: U → ℝⁿ', '座標変換: φ_β ∘ φ_α⁻¹', 'C^k多様体: 座標変換がk回微分可能'],
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        ...
        formulas: ['T_p M = {γ\'(0) : γ(0) = p}', 'Dimension: dim T_p M = dim M', 'Basis: ∂/∂x^i |_p'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['g: T_p M × T_p M → ℝ', 'ds² = g_{ij} dx^i dx^j', '길이: L(γ) = ∫√(g_{ij} γ̇^i γ̇^j) dt'],
      ...
      en: {
        ...
        formulas: ['g: T_p M × T_p M → ℝ', 'ds² = g_{ij} dx^i dx^j', 'Length: L(γ) = ∫√(g_{ij} γ̇^i γ̇^j) dt'],
      ...
      ja: {
        ...
        formulas: ['g: T_p M × T_p M → ℝ', 'ds² = g_{ij} dx^i dx^j', '長さ: L(γ) = ∫√(g_{ij} γ̇^i γ̇^j) dt'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['측지선 방정식: d²x^k/dt² + Γ^k_{ij} dx^i/dt dx^j/dt = 0', '크리스토펠 기호: Γ^k_{ij}'],
      ...
      en: {
        ...
        formulas: ['Geodesic equation: d²x^k/dt² + Γ^k_{ij} dx^i/dt dx^j/dt = 0', 'Christoffel symbols: Γ^k_{ij}'],
      ...
      ja: {
        ...
        formulas: ['測地線方程式: d²x^k/dt² + Γ^k_{ij} dx^i/dt dx^j/dt = 0', 'クリストッフェル記号: Γ^k_{ij}'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['리만 곡률: R^ρ_{σμν}', '리치 곡률: R_{μν} = R^ρ_{μρν}', '스칼라 곡률: R = g^{μν}R_{μν}'],
      ...
      en: {
        ...
        formulas: ['Riemann curvature: R^ρ_{σμν}', 'Ricci curvature: R_{μν} = R^ρ_{μρν}', 'Scalar curvature: R = g^{μν}R_{μν}'],
      ...
      ja: {
        ...
        formulas: ['リーマン曲率: R^ρ_{σμν}', 'リッチ曲率: R_{μν} = R^ρ_{μρν}', 'スカラー曲率: R = g^{μν}R_{μν}'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['0-형식: f', '1-형식: ω = f_i dx^i', '2-형식: ω = f_{ij} dx^i ∧ dx^j', '외미분: d'],
      ...
      en: {
        ...
        formulas: ['0-form: f', '1-form: ω = f_i dx^i', '2-form: ω = f_{ij} dx^i ∧ dx^j', 'Exterior derivative: d'],
        examples: ['dx, dy, dz', 'x dy - y dx', 'dx ∧ dy'],
        applications: ['Stokes theorem', 'Electromagnetism', 'de Rham cohomology']
      },
      ja: {
        definition: '座標に依らず積分を定義できる反対称テンソル場',
        formulas: ['0-形式: f', '1-形式: ω = f_i dx^i', '2-形式: ω = f_{ij} dx^i ∧ dx^j', '外微分: d'],
        examples: ['dx, dy, dz', 'x dy - y dx', 'dx ∧ dy'],
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        ...
        formulas: ['Group ops: (g,h) ↦ gh, g ↦ g⁻¹ are smooth', 'Lie algebra: T_e G', '[X,Y] = XY - YX'],
        examples: ['GL(n,ℝ)', 'SO(n)', 'SU(n)', 'SL(n,ℝ)'],
