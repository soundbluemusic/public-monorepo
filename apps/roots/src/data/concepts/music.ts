    ...
    content: {
      ...
      en: {
        ...
        history: {
          ...
          background:
            'Discovered relationship between string length and pitch, first linking music and math',
        },
        applications: [
    ...
    content: {
      ko: {
        ...
        formulas: [
          ...
          {
            latex:
              '\\text{음정}: \\text{기본음}, \\text{옥타브}, \\text{5도}, \\text{옥타브}, \\text{장3도}, \\text{5도}, ...',
      ...
      en: {
        ...
        formulas: [
          ...
          {
            latex:
              '\\text{Intervals}: \\text{root}, \\text{octave}, \\text{5th}, \\text{octave}, \\text{M3}, \\text{5th}, ...',
