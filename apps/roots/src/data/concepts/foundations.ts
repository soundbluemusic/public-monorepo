...
export const foundationsConcepts: MathConcept[] = [
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'A number that cannot be expressed as a fraction, with infinite non-repeating decimal expansion.',
        formulas: [
          {
            latex: '\\sqrt{2} = 1.41421356...',
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          '유리수와 무리수를 모두 포함하는 수의 집합으로, 수직선 위의 모든 점에 대응한다.',
        formulas: [
          {
      ...
      en: {
        definition:
          'The set of all rational and irrational numbers, corresponding to every point on the number line.',
        formulas: [
          {
            latex: '\\mathbb{R} = \\mathbb{Q} \\cup \\mathbb{I}',
    ...
    content: {
      ...
      en: {
        ...
        formulas: [
          {
            latex: 'a + b',
            description: 'Addition (sum)',
          },
          {
            latex: 'a - b',
            description: 'Subtraction (difference)',
          },
          {
            latex: 'a \\times b = a \\cdot b = ab',
            description: 'Multiplication (product)',
          },
          {
            latex: 'a \\div b = \\frac{a}{b}',
    ...
    content: {
      ko: {
        ...
        formulas: [
          ...
          },
          {
            ...
            description: '지수법칙: 나눗셈',
          },
          {
            latex: '(a^m)^n = a^{mn}',
            description: '지수법칙: 거듭제곱의 거듭제곱',
          },
          {
            latex: 'a^0 = 1 \\quad (a \\neq 0)',
            description: '0승은 1',
      ...
      en: {
        ...
        formulas: [
          ...
          {
            latex: 'a^m \\times a^n = a^{m+n}',
            description: 'Exponent rule: multiplication',
          },
          {
            latex: '\\frac{a^m}{a^n} = a^{m-n}',
            description: 'Exponent rule: division',
          },
          {
            latex: '(a^m)^n = a^{mn}',
            description: 'Exponent rule: power of a power',
          },
          {
            latex: 'a^0 = 1 \\quad (a \\neq 0)',
            description: 'Zero exponent equals 1',
          },
        ],
        examples: [
          {
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          '최대공약수(GCD)는 두 수의 공통 약수 중 가장 큰 수이고, 최소공배수(LCM)는 공통 배수 중 가장 작은 수이다.',
        formulas: [
          {
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'A number written using a decimal point to represent fractional parts as powers of ten.',
        formulas: [
          {
            latex: '0.abc = \\frac{a}{10} + \\frac{b}{100} + \\frac{c}{1000}',
    ...
    content: {
      ...
      en: {
        ...
        formulas: [
          {
            latex: 'p\\% = \\frac{p}{100}',
            description: 'Percentage to fraction',
          },
          {
    ...
    content: {
      ...
      en: {
        ...
        formulas: [
          ...
          {
            latex: '|z| = \\sqrt{a^2 + b^2}',
            description: 'Absolute value (modulus)',
          },
          {
            latex: '\\bar{z} = a - bi',
