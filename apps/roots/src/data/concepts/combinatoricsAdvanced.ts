...
export const combinatoricsAdvancedConcepts: MathConcept[] = [
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Tool encoding sequences as coefficients of polynomials or power series to solve combinatorial problems',
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Study of conditions guaranteeing regular substructures in large enough structures',
        formulas: [
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Method using probabilistic arguments to prove existence of combinatorial structures',
        formulas: [
