...
export const functionalAnalysisConcepts: MathConcept[] = [
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Complete normed space. Normed vector space where every Cauchy sequence converges',
        formulas: [
          '||x|| ≥ 0, ||x|| = 0 ⟺ x = 0',
          '||αx|| = |α| ||x||',
          '||x + y|| ≤ ||x|| + ||y||',
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Complete space with inner product. Infinite-dimensional generalization of Euclidean space',
        formulas: [
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Linear operator with finite norm. B(X,Y) is Banach space of bounded operators from X to Y',
        formulas: [
          '||T|| = sup{||Tx|| : ||x|| ≤ 1}',
          '||Tx|| ≤ ||T|| ||x||',
          'Bounded ⟺ Continuous',
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Self-adjoint (Hermitian) operators can be diagonalized via eigenvalues and eigenvectors',
        formulas: [
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Bounded linear functional on subspace can be extended to whole space preserving norm',
        formulas: [
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Surjective bounded linear operator between Banach spaces maps open sets to open sets',
        formulas: [
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Convergence with respect to all continuous linear functionals. Weaker than norm convergence',
        formulas: [
          'xₙ ⇀ x ⟺ ∀f ∈ X*, f(xₙ) → f(x)',
