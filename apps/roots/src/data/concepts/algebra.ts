...
export const algebraConcepts: MathConcept[] = [
    ...
    content: {
      ...
      en: {
        ...
        formulas: [
          {
            latex: 'x, y, z, a, b, c, ...',
            description: 'Commonly used variable symbols',
          },
        ],
        examples: [
          {
        ...
        formulas: [
          {
            ...
            description: '지수함수의 정의',
          },
          {
            latex: 'a^{x+y} = a^x \\cdot a^y',
            description: '지수법칙',
          },
          {
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          '지수함수의 역함수로, 어떤 수를 얻기 위해 밑을 몇 번 거듭제곱해야 하는지를 나타낸다.',
        formulas: [
          {
