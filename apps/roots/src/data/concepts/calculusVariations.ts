...
export const calculusVariationsConcepts: MathConcept[] = [
  {
    ...
    content: {
      ...
      en: {
        ...
        formulas: ['J[y] = ∫L(x,y,y\')dx', '∂L/∂y - d/dx(∂L/∂y\') = 0', 'Natural boundary conditions'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['T = ∫ds/v = ∫√(1+y\'²)/√(2gy) dx', '해: 사이클로이드', 'x = a(θ - sinθ), y = a(1 - cosθ)'],
      ...
      en: {
        ...
        formulas: ['T = ∫ds/v = ∫√(1+y\'²)/√(2gy) dx', 'Solution: cycloid', 'x = a(θ - sinθ), y = a(1 - cosθ)'],
      ...
      ja: {
        ...
        formulas: ['T = ∫ds/v = ∫√(1+y\'²)/√(2gy) dx', '解: サイクロイド', 'x = a(θ - sinθ), y = a(1 - cosθ)'],
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        ...
        formulas: ['max A = ∬dA, subject to ∮ds = L', 'Lagrange multiplier: δ(A - λP) = 0', 'Solution: circle'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['ẋ = f(x,u), min J = ∫L dt + Φ(x_f)', 'H = p·f - L', '∂H/∂u = 0 또는 경계', 'ṗ = -∂H/∂x'],
      ...
      en: {
        ...
        formulas: ['ẋ = f(x,u), min J = ∫L dt + Φ(x_f)', 'H = p·f - L', '∂H/∂u = 0 or boundary', 'ṗ = -∂H/∂x'],
      ...
      ja: {
        ...
        formulas: ['ẋ = f(x,u), min J = ∫L dt + Φ(x_f)', 'H = p·f - L', '∂H/∂u = 0 または境界', 'ṗ = -∂H/∂x'],
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        ...
        formulas: ['J: X → ℝ lower semicontinuous, coercive', 'inf J attained', 'Weak convergence + lower semicontinuity'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['대칭 ⟹ 보존 법칙', '시간 불변 → 에너지 보존', '공간 불변 → 운동량 보존', '회전 불변 → 각운동량 보존'],
      ...
      en: {
        ...
        formulas: ['Symmetry ⟹ Conservation law', 'Time invariance → Energy', 'Space invariance → Momentum', 'Rotation invariance → Angular momentum'],
        examples: ['Energy-momentum-angular momentum conservation', 'Gauge symmetry and charge conservation'],
        applications: ['Particle physics', 'General relativity', 'Field theory']
      },
      ja: {
        definition: '作用の連続対称性ごとに保存量が対応。物理学の根本定理',
        formulas: ['対称性 ⟹ 保存則', '時間不変 → エネルギー保存', '空間不変 → 運動量保存', '回転不変 → 角運動量保存'],
