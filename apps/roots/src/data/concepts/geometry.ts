...
export const geometryConcepts: MathConcept[] = [
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          "세 개의 직선으로 둘러싸인 다각형이다. 세 내각의 합은 항상 180°이다.",
        formulas: [
          {
      ...
      ko: {
        ...
        examples: [
          ...
          },
          {
            ...
            latex:
              "A = \\frac{1}{2} \\times 5 \\times 8 \\times \\sin 30° = 10\\text{cm}^2",
            difficulty: 3,
          },
        ],
      },
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          "대응하는 각이 모두 같고, 대응하는 변의 비가 일정한 두 삼각형을 닮음이라 한다.",
        formulas: [
          {
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          "네 개의 직선으로 둘러싸인 다각형이다. 내각의 합은 360°이다.",
        formulas: [
          {
      ...
      en: {
        ...
        examples: [
          ...
          {
            problem:
              "Find the area of a trapezoid with parallel sides 4cm and 8cm, height 5cm.",
            solution: "A = (4 + 8)/2 × 5 = 6 × 5 = 30cm²",
            difficulty: 2,
          },
        ],
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          "평면 위에서 한 점(중심)으로부터 같은 거리에 있는 모든 점의 집합이다.",
        formulas: [
          {
            latex: "C = 2\\pi r = \\pi d",
        ...
        examples: [
          {
            ...
            solution:
              "Circumference = 2π × 7 = 14π ≈ 43.96cm\nArea = π × 7² = 49π ≈ 153.86cm²",
            difficulty: 1,
          },
          {
  ...
  // ============================================
  {
    ...
    content: {
      ko: {
        definition:
          "좌표평면에서 두 점 사이의 직선 거리를 피타고라스 정리를 이용해 구한다.",
        formulas: [
          {
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          "원뿔을 평면으로 자를 때 생기는 곡선으로 원, 타원, 포물선, 쌍곡선이 있다.",
        formulas: [
          {
            latex: "x^2 + y^2 = r^2",
