...
export const categoryTheoryConcepts: MathConcept[] = [
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          'Key lemma establishing isomorphism between representable functors and natural transformations',
        formulas: [
          'Nat(Hom(A,-), F) ≅ F(A)',
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        definition:
          '"Best" approximations of diagrams in categories. Generalizes products, equalizers, pullbacks',
        formulas: [
