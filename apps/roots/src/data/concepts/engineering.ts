...
export const engineeringConcepts: MathConcept[] = [
  {
    ...
    content: {
      ...
      en: {
        ...
        formulas: ['Fourier Transform: F(ω) = ∫f(t)e^{-iωt}dt', 'Convolution: (f*g)(t) = ∫f(τ)g(t-τ)dτ'],
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        ...
        formulas: ['Transfer Function: H(s) = Y(s)/X(s)', 'PID Control: u(t) = Kp·e + Ki·∫e dt + Kd·de/dt'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['연속 방정식: ∂ρ/∂t + ∇·(ρv) = 0', '나비에-스토크스: ρ(∂v/∂t + v·∇v) = -∇p + μ∇²v'],
      ...
      ja: {
        ...
        formulas: ['連続の式: ∂ρ/∂t + ∇·(ρv) = 0', 'ナビエ-ストークス: ρ(∂v/∂t + v·∇v) = -∇p + μ∇²v'],
