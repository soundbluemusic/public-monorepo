/**
 * @fileoverview 복소해석학 개념 데이터
 */
import type { MathConcept } from "../types";

export const complexAnalysisConcepts: MathConcept[] = [
  {
    ...
    content: {
      ko: {
        definition:
          "복소함수는 복소수에서 복소수로의 함수입니다. f(z) = u(x,y) + iv(x,y)로 실수부와 허수부로 분해됩니다.",
        formulas: [
          {
            latex: "f(z) = f(x + iy) = u(x,y) + iv(x,y)",
            description: "복소함수의 분해",
          },
          {
        ...
        examples: [
          {
            ...
            solution:
              "z = x + iy일 때, z² = (x+iy)² = x² - y² + 2ixy. u(x,y) = x² - y², v(x,y) = 2xy.",
          },
          {
            problem: "e^(iπ)의 값은?",
            solution:
              "e^(iπ) = cos(π) + i·sin(π) = -1 + 0i = -1 (오일러 등식)",
          },
        ],
        history: {
          ...
          year: "1748년",
          background:
            "오일러가 e^(iθ) = cos θ + i sin θ를 발견하며 복소해석학의 기초를 놓았습니다.",
        },
        applications: [
        ...
        examples: [
          {
            ...
            solution:
              "For z = x + iy, z² = (x+iy)² = x² - y² + 2ixy. u(x,y) = x² - y², v(x,y) = 2xy.",
          },
          {
            problem: "What is e^(iπ)?",
            solution:
              "e^(iπ) = cos(π) + i·sin(π) = -1 + 0i = -1 (Euler's identity)",
          },
        ],
        history: {
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          "코시-리만 방정식은 복소함수가 미분가능(해석적)할 필요충분조건입니다. 실수부와 허수부의 편미분 관계를 나타냅니다.",
        formulas: [
          {
        ...
        examples: [
          {
            ...
            solution:
              "u = x² - y², v = 2xy. ∂u/∂x = 2x = ∂v/∂y ✓. ∂u/∂y = -2y = -∂v/∂x ✓. 해석적입니다.",
          },
          {
            problem: "f(z) = |z|²가 해석적이지 않음을 보이세요.",
            solution:
              "f(z) = x² + y². u = x² + y², v = 0. ∂u/∂x = 2x ≠ 0 = ∂v/∂y (원점 제외). 해석적이지 않습니다.",
          },
        ],
        history: {
          ...
          year: "1851년",
          background:
            "코시가 먼저 유도했고, 리만이 일반화하여 복소해석학의 기초가 되었습니다.",
        },
        applications: [
        ...
        examples: [
          {
            ...
            solution:
              "u = x² - y², v = 2xy. ∂u/∂x = 2x = ∂v/∂y ✓. ∂u/∂y = -2y = -∂v/∂x ✓. It's analytic.",
          },
          {
            problem: "Show f(z) = |z|² is not analytic.",
            solution:
              "f(z) = x² + y². u = x² + y², v = 0. ∂u/∂x = 2x ≠ 0 = ∂v/∂y (except origin). Not analytic.",
          },
        ],
        history: {
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          "해석함수(정칙함수)는 정의역의 모든 점에서 복소미분가능한 함수입니다. 무한 번 미분가능하고 테일러 급수로 표현됩니다.",
        formulas: [
          {
        ...
        examples: [
          {
            ...
            solution:
              "e^z = Σ(z^n/n!) = 1 + z + z²/2! + z³/3! + ... 수렴반경은 무한대입니다.",
          },
          {
            problem: "sin z의 급수 전개는?",
            solution:
              "sin z = z - z³/3! + z⁵/5! - z⁷/7! + ... = Σ((-1)^n z^(2n+1)/(2n+1)!)",
          },
        ],
        applications: [
      ...
      en: {
        definition:
          "An analytic (holomorphic) function is complex differentiable at every point in its domain. It's infinitely differentiable and expressible as Taylor series.",
        formulas: [
          {
            latex: "f(z) = \\sum_{n=0}^{\\infty} a_n (z - z_0)^n",
        ...
        examples: [
          {
            ...
            solution:
              "e^z = Σ(z^n/n!) = 1 + z + z²/2! + z³/3! + ... Radius of convergence is infinite.",
          },
          {
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          "유수 정리는 닫힌 경로를 따른 복소적분이 내부 특이점들의 유수 합으로 계산됨을 말합니다. 실수 적분 계산에 강력한 도구입니다.",
        formulas: [
          {
        ...
        examples: [
          {
            ...
            solution:
              "특이점: z = ±i (모두 내부). Res(f, i) = 1/(2i), Res(f, -i) = -1/(2i). 적분 = 2πi(1/(2i) - 1/(2i)) = 0",
          },
          {
            problem: "∫₀^∞ dx/(x²+1)을 유수로 계산하세요.",
            solution:
              "상반면 반원 경로. z = i만 내부. Res(f, i) = 1/(2i). ∮ = 2πi·(1/(2i)) = π. 실수축 기여만 남아 ∫₀^∞ = π/2",
          },
        ],
        history: {
          ...
          year: "1825년",
          background:
            "코시가 복소적분론을 개발하면서 유수 정리를 증명했습니다.",
        },
        applications: [
        ...
        examples: [
          {
            ...
            solution:
              "Singularities: z = ±i (both inside). Res(f, i) = 1/(2i), Res(f, -i) = -1/(2i). Integral = 2πi(1/(2i) - 1/(2i)) = 0",
          },
          {
            problem: "Compute ∫₀^∞ dx/(x²+1) using residues.",
            solution:
              "Upper semicircle contour. Only z = i inside. Res(f, i) = 1/(2i). ∮ = 2πi·(1/(2i)) = π. Real axis contribution: ∫₀^∞ = π/2",
          },
        ],
        history: {
  ...
  },
  {
    ...
    content: {
      ko: {
        definition:
          "등각사상은 각도를 보존하는 변환입니다. 해석함수는 f'(z) ≠ 0인 점에서 등각입니다. 복잡한 영역을 단순한 영역으로 변환합니다.",
        formulas: [
          {
            latex: "w = f(z), \\quad f'(z_0) \\neq 0",
            description: "등각사상의 조건",
          },
          {
          ...
          {
            latex: "w = e^z",
            description: "띠 영역을 쐐기 영역으로",
          },
          {
            latex: "w = \\frac{z - i}{z + i}",
            description: "카일리 변환 (상반면 → 단위원)",
          },
        ],
        examples: [
          {
            ...
            solution:
              "z = re^(iθ), 0 < θ < π/2일 때, w = r²e^(2iθ), 0 < 2θ < π. 제1사분면이 상반면으로 사상됩니다.",
          },
          {
            problem: "뫼비우스 변환이 원을 원으로 보냄을 설명하세요.",
            solution:
              "뫼비우스 변환은 원과 직선을 원과 직선으로 사상합니다. 직선은 무한대를 지나는 원으로 볼 수 있습니다.",
          },
        ],
        history: {
          ...
          year: "1851년",
          background:
            "리만 사상 정리: 단순 연결 영역은 단위 원판과 등각동형입니다.",
        },
        applications: [
        ...
        examples: [
          {
            ...
            solution:
              "For z = re^(iθ), 0 < θ < π/2, w = r²e^(2iθ), 0 < 2θ < π. First quadrant maps to upper half-plane.",
          },
          {
            problem: "Explain why Möbius maps circles to circles.",
            solution:
              "Möbius transformations map circles and lines to circles and lines. Lines are circles passing through infinity.",
          },
        ],
        history: {
