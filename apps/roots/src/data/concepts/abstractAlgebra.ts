      ...
      ko: {
        ...
        examples: [
          ...
          },
          {
            ...
            solution:
              "3개 원소를 배열하는 방법의 수 = 3! = 6. S₃는 위수 6인 비아벨군입니다.",
          },
        ],
        history: {
    ...
    content: {
      ko: {
        ...
        history: {
          ...
          year: "19세기",
          background:
            "대수방정식 연구와 대수적 수론의 발전 과정에서 체 개념이 정립되었습니다.",
        },
        applications: [
      ...
      ko: {
        ...
        examples: [
          ...
          },
          {
            ...
            solution:
              "ker(φ) = {a ∈ ℤ : a ≡ 0 (mod n)} = nℤ. n의 배수 전체입니다.",
          },
        ],
        applications: [
      ...
      en: {
        ...
        examples: [
          ...
          },
          {
            ...
            solution:
              "ker(φ) = {a ∈ ℤ : a ≡ 0 (mod n)} = nℤ. All multiples of n.",
          },
        ],
        applications: [
    ...
    content: {
      ko: {
        ...
        history: {
          ...
          year: "1920년대",
          background:
            "뇌터가 동형정리를 일반화하고 현대 대수학의 기초를 놓았습니다.",
        },
        applications: [
