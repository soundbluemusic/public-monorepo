  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['구간의 측도: λ([a,b]) = b - a', '가산 가법성: λ(∪A_n) = Σλ(A_n) (서로소)', '외측도: λ*(A) = inf{Σℓ(I_n): A ⊆ ∪I_n}'],
      ...
      en: {
        ...
        formulas: ['Interval measure: λ([a,b]) = b - a', 'Countable additivity: λ(∪A_n) = Σλ(A_n) (disjoint)', 'Outer measure: λ*(A) = inf{Σℓ(I_n): A ⊆ ∪I_n}'],
      ...
      ja: {
        ...
        formulas: ['区間の測度: λ([a,b]) = b - a', '可算加法性: λ(∪A_n) = Σλ(A_n) (互いに素)', '外測度: λ*(A) = inf{Σℓ(I_n): A ⊆ ∪I_n}'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['단순함수: ∫φ dμ = Σa_i μ(A_i)', '일반함수: ∫f dμ = sup{∫φ dμ: φ ≤ f, φ 단순}', 'MCT, DCT'],
      ...
      en: {
        ...
        formulas: ['Simple function: ∫φ dμ = Σa_i μ(A_i)', 'General: ∫f dμ = sup{∫φ dμ: φ ≤ f, φ simple}', 'MCT, DCT'],
      ...
      ja: {
        ...
        formulas: ['単関数: ∫φ dμ = Σa_i μ(A_i)', '一般: ∫f dμ = sup{∫φ dμ: φ ≤ f, φ 単関数}', 'MCT, DCT'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['∬f d(μ×ν) = ∫(∫f(x,y) dν(y)) dμ(x) = ∫(∫f(x,y) dμ(x)) dν(y)', '조건: f가 적분 가능 또는 비음'],
      ...
      en: {
        ...
        formulas: ['∬f d(μ×ν) = ∫(∫f(x,y) dν(y)) dμ(x) = ∫(∫f(x,y) dμ(x)) dν(y)', 'Condition: f integrable or non-negative'],
      ...
      ja: {
        ...
        formulas: ['∬f d(μ×ν) = ∫(∫f(x,y) dν(y)) dμ(x) = ∫(∫f(x,y) dμ(x)) dν(y)', '条件: fが可積分または非負'],
  ...
  },
  {
    ...
    content: {
      ...
      en: {
        ...
        formulas: ['Condition: |f_n| ≤ g, ∫g < ∞', 'Conclusion: lim∫f_n = ∫lim f_n', 'i.e.: ∫f = lim∫f_n'],
  ...
  },
  {
    ...
    content: {
      ko: {
        ...
        formulas: ['||f||_p = (∫|f|^p dμ)^{1/p}', 'L^∞: ||f||_∞ = ess sup |f|', '횔더: ||fg||_1 ≤ ||f||_p||g||_q (1/p+1/q=1)'],
        examples: ['L²(ℝ): 제곱적분 가능', 'L^∞: 본질적 유계'],
        applications: ['푸리에 해석', '양자역학', 'PDE']
      },
      en: {
        definition: 'Banach space of p-power integrable functions',
        formulas: ['||f||_p = (∫|f|^p dμ)^{1/p}', 'L^∞: ||f||_∞ = ess sup |f|', 'Hölder: ||fg||_1 ≤ ||f||_p||g||_q (1/p+1/q=1)'],
      ...
      ja: {
        ...
        formulas: ['||f||_p = (∫|f|^p dμ)^{1/p}', 'L^∞: ||f||_∞ = ess sup |f|', 'ヘルダー: ||fg||_1 ≤ ||f||_p||g||_q (1/p+1/q=1)'],
