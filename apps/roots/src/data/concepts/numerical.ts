        ...
        examples: [
          {
            ...
            solution:
              "f(1) = -1 < 0, f(2) = 2 > 0. c = 1.5, f(1.5) = 0.25 > 0. 새 구간 [1, 1.5]. c = 1.25, f(1.25) = -0.4375 < 0. [1.25, 1.5]... 계속하면 √2 ≈ 1.414로 수렴",
          },
        ],
        applications: [
        ...
        examples: [
          {
            ...
            solution:
              "f(1) = -1 < 0, f(2) = 2 > 0. c = 1.5, f(1.5) = 0.25 > 0. New interval [1, 1.5]. c = 1.25, f(1.25) = -0.4375 < 0. [1.25, 1.5]... Converges to √2 ≈ 1.414",
          },
        ],
        applications: [
        ...
        examples: [
          {
            ...
            solution:
              "k₁ = 1, k₂ = 1.05, k₃ = 1.0525, k₄ = 1.10525. y₁ = 1 + (0.1/6)(1 + 2.1 + 2.105 + 1.10525) = 1.10517... (정확해 e^0.1 ≈ 1.10517)",
          },
        ],
        history: {
          ...
          year: "1901년",
          background:
            "오일러 방법의 정확도를 개선하기 위해 여러 기울기를 조합하는 방법을 개발했습니다.",
        },
        applications: [
        ...
        examples: [
          {
            ...
            solution:
              "k₁ = 1, k₂ = 1.05, k₃ = 1.0525, k₄ = 1.10525. y₁ = 1 + (0.1/6)(1 + 2.1 + 2.105 + 1.10525) = 1.10517... (exact e^0.1 ≈ 1.10517)",
          },
        ],
        history: {
        ...
        examples: [
          {
            ...
            solution:
              "A = LU로 분해. Ly = b를 전진대입으로 풀고, Ux = y를 후진대입으로 풉니다. 같은 A에 대해 여러 b를 풀 때 효율적입니다.",
          },
        ],
        applications: [
        ...
        examples: [
          {
            ...
            solution:
              "Factor A = LU. Solve Ly = b by forward substitution, then Ux = y by back substitution. Efficient for multiple b with same A.",
          },
        ],
        applications: [
          { field: "Numerical Linear Algebra", description: "Solving linear systems" },
          { field: "Machine Learning", description: "Dimensionality reduction, recommender systems" },
        ...
        examples: [
          {
            ...
            solution:
              "u(x,t+Δt) - u(x,t))/Δt = α(u(x+Δx,t) - 2u(x,t) + u(x-Δx,t))/Δx². 이를 정리하면 명시적 시간 진행 스킴이 됩니다.",
          },
        ],
        applications: [
        ...
        examples: [
          {
            ...
            solution:
              "(u(x,t+Δt) - u(x,t))/Δt = α(u(x+Δx,t) - 2u(x,t) + u(x-Δx,t))/Δx². Rearranging gives explicit time-stepping scheme.",
          },
        ],
        applications: [
