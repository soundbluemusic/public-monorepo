    ...
    content: {
      ko: {
        ...
        formulas: [
          {
            latex:
              'f: X \\to Y \\text{ homeomorphism} \\Leftrightarrow f, f^{-1} \\text{ continuous bijection}',
    ...
    content: {
      ko: {
        ...
        formulas: [
          {
            latex:
              'X = \\bigcup_{\\alpha} U_\\alpha \\Rightarrow X = \\bigcup_{i=1}^{n} U_{\\alpha_i}',
    ...
    content: {
      ko: {
        ...
        formulas: [
          ...
          {
            latex:
              'X \\simeq Y \\Leftrightarrow \\exists f: X \\to Y, g: Y \\to X : g \\circ f \\simeq id_X, f \\circ g \\simeq id_Y',
            description: '호모토피 동치',
          },
        ],
        examples: [
