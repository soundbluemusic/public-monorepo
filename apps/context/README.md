...
[![SSG Routes](https://img.shields.io/badge/SSG_Routes-46364-blue)](react-router.config.ts)
...
- **23145 Word Entries** - Organized by category and difficulty
...
├── ssr: false
├── prerender() → 46364 static routes generated
│   ├── entries → 23145 × 2 langs
...
├── entry/{id}.html, ko/entry/{id}.html (×23145)
...
| `/entry/:entryId` | ✓ | ✓ | 23145 | Word entry page |
...
**Total:** 46364 SSG routes (23182 EN + 23182 KO)
