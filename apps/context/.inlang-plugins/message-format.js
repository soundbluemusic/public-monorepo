...
var he = Rn((o) => {
  ...
  o.Type =
    o.JsonType =
    o.JavaScriptTypeBuilder =
    o.JsonTypeBuilder =
    o.TypeBuilder =
    o.TypeBuilderError =
    o.TransformEncodeBuilder =
    o.TransformDecodeBuilder =
    o.TemplateLiteralDslParser =
    o.TemplateLiteralGenerator =
    o.TemplateLiteralGeneratorError =
    o.TemplateLiteralFinite =
    o.TemplateLiteralFiniteError =
    o.TemplateLiteralParser =
    o.TemplateLiteralParserError =
    o.TemplateLiteralResolver =
    o.TemplateLiteralPattern =
    o.TemplateLiteralPatternError =
    o.UnionResolver =
    o.KeyArrayResolver =
    o.KeyArrayResolverError =
    o.KeyResolver =
    o.ObjectMap =
    o.Intrinsic =
    o.IndexedAccessor =
    ...
    o.ExtendsUndefined =
    o.TypeGuard =
    o.TypeGuardUnknownTypeError =
    o.ValueGuard =
    o.FormatRegistry =
    o.TypeBoxError =
    o.TypeRegistry =
    o.PatternStringExact =
    o.PatternNumberExact =
    o.PatternBooleanExact =
    o.PatternString =
    o.PatternNumber =
    o.PatternBoolean =
    o.Kind =
  ...
  (function (s) {
    ...
    s.IsBoolean = u;
    function p(m) {
      return m instanceof globalThis.Date;
    }
    s.IsDate = p;
    function l(m) {
      return m === null;
    ...
    s.IsString = y;
    function b(m) {
      return m instanceof globalThis.Uint8Array;
    }
    s.IsUint8Array = b;
    function g(m) {
      return m === void 0;
  ...
  (function (s) {
    ...
    function y(r) {
      return I.IsUndefined(r) || (I.IsString(r) && i(r) && e(r));
    }
    function b(r) {
      return I.IsUndefined(r) || (I.IsString(r) && i(r));
    }
    function g(r) {
      return I.IsUndefined(r) || C(r);
    }
    function m(r) {
      return S(r, 'Any') && T(r.$id);
    }
    s.TAny = m;
    function U(r) {
      return (
    ...
    s.TArray = U;
    function d(r) {
      return S(r, 'AsyncIterator') && r.type === 'AsyncIterator' && T(r.$id) && C(r.items);
    }
    s.TAsyncIterator = d;
    function O(r) {
      return (
        ...
        r.type === 'bigint' &&
        T(r.$id) &&
        p(r.exclusiveMaximum) &&
        p(r.exclusiveMinimum) &&
        p(r.maximum) &&
        p(r.minimum) &&
        p(r.multipleOf)
      );
    ...
    s.TBigInt = O;
    function v(r) {
      return S(r, 'Boolean') && r.type === 'boolean' && T(r.$id);
    }
    s.TBoolean = v;
    function N(r) {
      return (
        ...
        r.type === 'Constructor' &&
        T(r.$id) &&
        I.IsArray(r.parameters) &&
        r.parameters.every((L) => C(L)) &&
        C(r.returns)
      );
    }
    s.TConstructor = N;
    ...
    function K(r) {
      return (
        S(r, 'Intersect') &&
        !(I.IsString(r.type) && r.type !== 'object') &&
        I.IsArray(r.allOf) &&
        r.allOf.every((L) => C(L) && !oe(L)) &&
        T(r.type) &&
        (c(r.unevaluatedProperties) || g(r.unevaluatedProperties)) &&
        T(r.$id)
      );
    }
    s.TIntersect = K;
    function pe(r) {
      return S(r, 'Iterator') && r.type === 'Iterator' && T(r.$id) && C(r.items);
    }
    s.TIterator = pe;
    function S(r, L) {
      return ee(r) && r[o.Kind] === L;
    }
    s.TKindOf = S;
    function ee(r) {
      return I.IsObject(r) && o.Kind in r && I.IsString(r[o.Kind]);
    }
    s.TKind = ee;
    function ne(r) {
      return V(r) && I.IsString(r.const);
    }
    s.TLiteralString = ne;
    function Te(r) {
      return V(r) && I.IsNumber(r.const);
    }
    s.TLiteralNumber = Te;
    function Ke(r) {
      return V(r) && I.IsBoolean(r.const);
    }
    s.TLiteralBoolean = Ke;
    function V(r) {
      return (
        S(r, 'Literal') &&
        T(r.$id) &&
        (I.IsBoolean(r.const) || I.IsNumber(r.const) || I.IsString(r.const))
      );
    }
    s.TLiteral = V;
    function fe(r) {
      return S(r, 'Never') && I.IsObject(r.not) && Object.getOwnPropertyNames(r.not).length === 0;
    }
    s.TNever = fe;
    function $(r) {
      return S(r, 'Not') && C(r.not);
    }
    s.TNot = $;
    function te(r) {
      return S(r, 'Null') && r.type === 'null' && T(r.$id);
    }
    s.TNull = te;
    function re(r) {
      return (
    ...
    function _(r) {
      return (
        ...
        r.type === 'object' &&
        T(r.$id) &&
        I.IsObject(r.properties) &&
        u(r.additionalProperties) &&
        l(r.minProperties) &&
        l(r.maxProperties) &&
        Object.entries(r.properties).every(([L, B]) => i(L) && C(B))
      );
    }
    s.TObject = _;
    function ie(r) {
      return S(r, 'Promise') && r.type === 'Promise' && T(r.$id) && C(r.item);
    }
    s.TPromise = ie;
    function de(r) {
      return (
        ...
        ((L) => {
          ...
          return (
            B.length === 1 &&
            e(B[0]) &&
            I.IsObject(L.patternProperties) &&
            C(L.patternProperties[B[0]])
          );
        })(r)
      );
    }
    s.TRecord = de;
    function Ee(r) {
      return I.IsObject(r) && o.Hint in r && r[o.Hint] === 'Recursive';
    }
    s.TRecursive = Ee;
    function ye(r) {
      return S(r, 'Ref') && T(r.$id) && I.IsString(r.$ref);
    }
    s.TRef = ye;
    function me(r) {
      return (
    ...
    s.TString = me;
    function ge(r) {
      return S(r, 'Symbol') && r.type === 'symbol' && T(r.$id);
    }
    s.TSymbol = ge;
    function z(r) {
      return (
        S(r, 'TemplateLiteral') &&
        r.type === 'string' &&
        I.IsString(r.pattern) &&
        r.pattern[0] === '^' &&
        r.pattern[r.pattern.length - 1] === '$'
      );
    }
    s.TTemplateLiteral = z;
    function Ie(r) {
      return S(r, 'This') && T(r.$id) && I.IsString(r.$ref);
    }
    s.TThis = Ie;
    function oe(r) {
      return I.IsObject(r) && o.Transform in r;
    }
    s.TTransform = oe;
    function F(r) {
      return (
        ...
        r.type === 'array' &&
        T(r.$id) &&
        I.IsNumber(r.minItems) &&
        I.IsNumber(r.maxItems) &&
        r.minItems === r.maxItems &&
        ((I.IsUndefined(r.items) && I.IsUndefined(r.additionalItems) && r.minItems === 0) ||
          (I.IsArray(r.items) && r.items.every((L) => C(L))))
      );
    }
    s.TTuple = F;
    function be(r) {
      return S(r, 'Undefined') && r.type === 'undefined' && T(r.$id);
    }
    s.TUndefined = be;
    function Be(r) {
      return q(r) && r.anyOf.every((L) => ne(L) || Te(L));
    }
    s.TUnionLiteral = Be;
    function q(r) {
      return (
    ...
    s.TUnsafe = Oe;
    function se(r) {
      return S(r, 'Void') && r.type === 'void' && T(r.$id);
    }
    s.TVoid = se;
    function Me(r) {
      return I.IsObject(r) && r[o.Readonly] === 'Readonly';
    }
    s.TReadonly = Me;
    function De(r) {
      return I.IsObject(r) && r[o.Optional] === 'Optional';
    }
    s.TOptional = De;
    function C(r) {
      return (
  ...
  (function (s) {
    ...
    function u(n) {
      return a.TNever(n) || a.TIntersect(n) || a.TUnion(n) || a.TUnknown(n) || a.TAny(n);
    }
    function p(n, t) {
      return a.TNever(t)
        ? S(n, t)
    ...
    function c(n, t) {
      return a.TIntersect(t)
        ? R(n, t)
        : a.TUnion(t) && t.anyOf.some((x) => a.TAny(x) || a.TUnknown(x))
          ? f.True
          : a.TUnion(t)
            ? f.Union
            : a.TUnknown(t) || a.TAny(t)
              ? f.True
              : f.Union;
    }
    function T(n, t) {
    ...
    function b(n, t) {
      return u(t) ? p(n, t) : a.TAsyncIterator(t) ? e(w(n.items, t.items)) : f.False;
    }
    function g(n, t) {
      return u(t)
        ? p(n, t)
    ...
    function d(n, t) {
      return u(t)
        ...
        : a.TObject(t)
          ? F(n, t)
          : a.TConstructor(t)
            ? n.parameters.length > t.parameters.length
              ? f.False
              : n.parameters.every((x, M) => e(w(t.parameters[M], x)) === f.True)
                ? e(w(n.returns, t.returns))
                : f.False
            : f.False;
    }
    function O(n, t) {
    ...
    function j(n, t) {
      return a.TInteger(t) || a.TNumber(t)
        ? f.True
        : u(t)
          ? p(n, t)
          : a.TObject(t)
    ...
    function R(n, t) {
      return t.allOf.every((x) => w(n, x) === f.True) ? f.True : f.False;
    }
    function A(n, t) {
      return n.allOf.some((x) => w(x, t) === f.True) ? f.True : f.False;
    }
    function K(n, t) {
      return u(t) ? p(n, t) : a.TIterator(t) ? e(w(n.items, t.items)) : f.False;
    }
    function pe(n, t) {
      return a.TLiteral(t) && t.const === n.const
        ? f.True
        : u(t)
          ? p(n, t)
          : a.TObject(t)
    ...
    function Te(n, t) {
      return a.TNot(n) ? w(ne(n), t) : a.TNot(t) ? w(n, ne(t)) : i('Invalid fallthrough for Not');
    }
    function Ke(n, t) {
      return u(t)
        ? p(n, t)
    ...
    function re(n) {
      return (
        $(n, 0) ||
        ($(n, 1) &&
          'description' in n.properties &&
          a.TUnion(n.properties.description) &&
          n.properties.description.anyOf.length === 2 &&
          ((a.TString(n.properties.description.anyOf[0]) &&
            a.TUndefined(n.properties.description.anyOf[1])) ||
            (a.TString(n.properties.description.anyOf[1]) &&
              a.TUndefined(n.properties.description.anyOf[0]))))
      );
    }
    function _(n) {
      return $(n, 0);
    ...
    function oe(n, t) {
      return w(n, t) === f.False || (a.TOptional(n) && !a.TOptional(t)) ? f.False : f.True;
    }
    function F(n, t) {
      return a.TUnknown(n)
        ? f.False
        : a.TAny(n)
          ? f.Union
          : a.TNever(n) ||
              (a.TLiteralString(n) && te(t)) ||
              (a.TLiteralNumber(n) && _(t)) ||
              (a.TLiteralBoolean(n) && ie(t)) ||
              (a.TSymbol(n) && re(t)) ||
              (a.TBigInt(n) && de(t)) ||
              (a.TString(n) && te(t)) ||
              (a.TSymbol(n) && re(t)) ||
              ...
              (a.TInteger(n) && _(t)) ||
              (a.TBoolean(n) && ie(t)) ||
              (a.TUint8Array(n) && ye(t)) ||
              (a.TDate(n) && Ee(t)) ||
              (a.TConstructor(n) && ge(t)) ||
              (a.TFunction(n) && me(t))
            ? f.True
            : a.TRecord(n) && a.TString(q(n))
              ? t[o.Hint] === 'Record'
                ? f.True
                : f.False
              : a.TRecord(n) && a.TNumber(q(n))
                ? $(t, 0)
                  ? f.True
                  : f.False
                : f.False;
    ...
    function q(n) {
      return o.PatternNumberExact in n.patternProperties
        ? o.Type.Number()
        : o.PatternStringExact in n.patternProperties
          ? o.Type.String()
          : i('Unknown record key pattern');
    }
    function W(n) {
      return o.PatternNumberExact in n.patternProperties
        ? n.patternProperties[o.PatternNumberExact]
        : o.PatternStringExact in n.patternProperties
          ? n.patternProperties[o.PatternStringExact]
    ...
    function E(n, t) {
      ...
      return a.TLiteralString(n) && a.TNumber(x) && e(w(n, M)) === f.True
        ...
        : (a.TUint8Array(n) && a.TNumber(x)) ||
            (a.TString(n) && a.TNumber(x)) ||
            (a.TArray(n) && a.TNumber(x))
          ? w(n, M)
          : a.TObject(n)
            ? (() => {
    ...
    function C(n, t) {
      return a.TTemplateLiteral(n)
        ? w(k.Resolve(n), t)
        : a.TTemplateLiteral(t)
          ? w(n, k.Resolve(t))
          : i('Invalid fallthrough for TemplateLiteral');
    }
    function r(n, t) {
    ...
    function B(n, t) {
      return u(t)
        ...
        : (a.TObject(t) && z(t)) || (a.TArray(t) && r(n, t))
          ? f.True
          : a.TTuple(t)
            ? (I.IsUndefined(n.items) && !I.IsUndefined(t.items)) ||
              (!I.IsUndefined(n.items) && I.IsUndefined(t.items))
              ? f.False
              : (I.IsUndefined(n.items) && !I.IsUndefined(t.items)) ||
                  n.items.every((x, M) => w(x, t.items[M]) === f.True)
                ? f.True
                : f.False
            : f.False;
    }
    ...
    function ke(n, t) {
      return t.anyOf.some((x) => w(n, x) === f.True) ? f.True : f.False;
    }
    function yn(n, t) {
    ...
    function w(n, t) {
      return a.TTemplateLiteral(n) || a.TTemplateLiteral(t)
        ? C(n, t)
        : a.TNot(n) || a.TNot(t)
          ? Te(n, t)
          : a.TAny(n)
                                                        ...
                                                        : a.TUnion(n)
                                                          ...
                                                          : a.TUnknown(n)
                                                            ...
                                                            : a.TVoid(n)
                                                              ? In(n, t)
                                                              : i(
                                                                  `Unknown left type operand '${n[o.Kind]}'`,
                                                                );
    }
    function bn(n, t) {
      return w(n, t);
  ...
  (function (s) {
    ...
    function i(d) {
      return d.every((O) => a.TOptional(O));
    }
    function u(d) {
      return d.some((O) => a.TOptional(O));
    }
    function p(d) {
      return i(d.allOf) ? o.Type.Optional(o.Type.Intersect(e(d.allOf))) : d;
    }
    function l(d) {
      return u(d.anyOf) ? o.Type.Optional(o.Type.Union(e(d.anyOf))) : d;
    }
    function c(d) {
  ...
  (function (s) {
    ...
    function y(g, m) {
      return a.TTemplateLiteral(g)
        ? l(g, m)
        : a.TUnion(g)
          ? o.Type.Union(T(g.anyOf, m))
          : a.TLiteral(g)
            ? o.Type.Literal(c(g.const, m))
            : g;
    }
    function b(g, m) {
      return y(g, m);
  ...
  (function (s) {
    ...
    function l(b, g) {
      return g.includePatterns ? Object.getOwnPropertyNames(b.patternProperties) : [];
    }
    function c(b, g) {
      return a.TIntersect(b)
        ? i(b, g)
        : a.TUnion(b)
          ? u(b, g)
          : a.TObject(b)
    ...
    function T(b, g) {
      return [...new Set(c(b, g))];
    }
    s.ResolveKeys = T;
    function y(b) {
      return `^(${T(b, { includePatterns: !0 })
        .map((U) => `(${e(U)})`)
        .join('|')})$`;
    }
    s.ResolvePattern = y;
  ...
  (function (s) {
    function e(i) {
      return Array.isArray(i)
        ? i
        : a.TUnionLiteral(i)
          ? i.anyOf.map((u) => u.const.toString())
          : a.TLiteral(i)
            ? [i.const]
  ...
  (function (s) {
    ...
    function u(l, c) {
      return a.TTemplateLiteral(l)
        ? l.pattern.slice(1, l.pattern.length - 1)
        : a.TUnion(l)
          ? `(${l.anyOf.map((T) => u(T, c)).join('|')})`
          : a.TNumber(l)
            ? `${c}${o.PatternNumber}`
            : a.TInteger(l)
              ? `${c}${o.PatternNumber}`
              : a.TBigInt(l)
                ...
                : a.TString(l)
                  ? `${c}${o.PatternString}`
                  : a.TLiteral(l)
                    ? `${c}${i(l.const.toString())}`
                    : a.TBoolean(l)
                      ? `${c}${o.PatternBoolean}`
                      : e(`Unexpected Kind '${l[o.Kind]}'`);
    }
    function p(l) {
      return `^${l.map((c) => u(c, '')).join('')}$`;
    }
    s.Create = p;
  ...
  (function (s) {
    ...
    function l(d) {
      if (!(i(d, 0) && u(d, d.length - 1))) return !1;
      let O = 0;
      for (let v = 0; v < d.length; v++)
        if ((i(d, v) && (O += 1), u(d, v) && (O -= 1), O === 0 && v !== d.length - 1)) return !1;
      return !0;
    }
    function c(d) {
    ...
    function T(d) {
      let O = 0;
      for (let v = 0; v < d.length; v++)
        if ((i(d, v) && (O += 1), u(d, v) && (O -= 1), p(d, v) && O === 0)) return !0;
      return !1;
    }
    function y(d) {
      for (let O = 0; O < d.length; O++) if (i(d, O)) return !0;
      return !1;
    }
    function b(d) {
      let [O, v] = [0, 0],
    ...
    function g(d) {
      function O(j, R) {
        if (!i(j, R)) throw new ue('TemplateLiteralParser: Index must point to open parens');
        let A = 0;
        for (let K = R; K < j.length; K++)
          if ((i(j, K) && (A += 1), u(j, K) && (A -= 1), A === 0)) return [R, K];
    ...
    function m(d) {
      return l(d) ? m(c(d)) : T(d) ? b(d) : y(d) ? g(d) : { type: 'const', const: d };
    }
    s.Parse = m;
    function U(d) {
      return m(d.slice(1, d.length - 1));
    }
    s.ParseExact = U;
      ...
      return c.type === 'and'
        ...
        : c.type === 'or'
          ...
          : c.type === 'const'
            ? yield* p(c)
            : (() => {
                throw new xe('Unknown expression');
              })();
    }
    s.Generate = l;
  ...
  var le = class extends Ae {
    ...
    Readonly(e) {
      return { ...P.Type(e), [o.Readonly]: 'Readonly' };
    }
    Optional(e) {
      return { ...P.Type(e), [o.Optional]: 'Optional' };
    }
    Any(e = {}) {
      return this.Create({ ...e, [o.Kind]: 'Any' });
    }
    Array(e, i = {}) {
      return this.Create({ ...i, [o.Kind]: 'Array', type: 'array', items: P.Type(e) });
    }
    Boolean(e = {}) {
      return this.Create({ ...e, [o.Kind]: 'Boolean', type: 'boolean' });
    }
    Capitalize(e, i = {}) {
    ...
    Extends(e, i, u, p, l = {}) {
      switch (J.Extends(e, i)) {
        case f.Union:
          return this.Union([P.Type(u, l), P.Type(p, l)]);
        case f.True:
          return P.Type(u, l);
        case f.False:
          return P.Type(p, l);
    ...
    Integer(e = {}) {
      return this.Create({ ...e, [o.Kind]: 'Integer', type: 'integer' });
    }
    Intersect(e, i = {}) {
      ...
      return i.unevaluatedProperties === !1 || a.TSchema(i.unevaluatedProperties) || u
        ? this.Create({ ...i, ...l, [o.Kind]: 'Intersect', type: 'object', allOf: p })
        : this.Create({ ...i, ...l, [o.Kind]: 'Intersect', allOf: p });
    }
    KeyOf(e, i = {}) {
      return a.TRecord(e)
        ? (() => {
    ...
    Literal(e, i = {}) {
      return this.Create({ ...i, [o.Kind]: 'Literal', const: e, type: typeof e });
    }
    Lowercase(e, i = {}) {
      return { ...Y.Map(P.Type(e), 'Lowercase'), ...i };
    }
    Never(e = {}) {
      return this.Create({ ...e, [o.Kind]: 'Never', not: {} });
    }
    Not(e, i) {
      return this.Create({ ...i, [o.Kind]: 'Not', not: P.Type(e) });
    }
    Null(e = {}) {
      return this.Create({ ...e, [o.Kind]: 'Null', type: 'null' });
    }
    Number(e = {}) {
    ...
    Partial(e, i = {}) {
      return Q.Map(
        ...
        (u) => {
          ...
          return this.Object(p, this.Discard(u, ['required']));
        },
        i,
      );
    }
        ...
        ? (() => {
            ...
            return Z.Check(p)
              ...
              : this.Create({
                  ...
                  [o.Kind]: 'Record',
                  type: 'object',
                  patternProperties: { [e.pattern]: P.Type(i) },
                });
          })()
        : a.TUnion(e)
          ? (() => {
          ...
          : a.TLiteral(e)
            ? I.IsString(e.const) || I.IsNumber(e.const)
              ? this.Object({ [e.const]: P.Type(i) }, u)
              : this.Throw('Record key of type literal is not of type string or number')
            : a.TInteger(e) || a.TNumber(e)
              ? this.Create({
                  ...u,
                  [o.Kind]: 'Record',
                  type: 'object',
                  patternProperties: { [o.PatternNumberExact]: P.Type(i) },
                })
              : a.TString(e)
                ? (() => {
    ...
    Ref(e, i = {}) {
      return I.IsString(e)
        ? this.Create({ ...i, [o.Kind]: 'Ref', $ref: e })
        : (I.IsUndefined(e.$id) && this.Throw('Reference target type must specify an $id'),
          this.Create({ ...i, [o.Kind]: 'Ref', $ref: e.$id }));
    }
    Required(e, i = {}) {
      return Q.Map(
        this.Discard(P.Type(e), ['$id', o.Transform]),
        (u) => {
          ...
          return this.Object(p, u);
        },
        i,
      );
    }
    Rest(e) {
      return a.TTuple(e) && !I.IsUndefined(e.items)
        ? P.Rest(e.items)
        : a.TIntersect(e)
          ? P.Rest(e.allOf)
          : a.TUnion(e)
      ...
      let [u, p, l] = [!1, e.length, e.length],
        ...
        T =
          e.length > 0
            ...
            : { ...i, [o.Kind]: 'Tuple', type: 'array', minItems: p, maxItems: l };
      return this.Create(T);
    }
    Uncapitalize(e, i = {}) {
      return { ...Y.Map(P.Type(e), 'Uncapitalize'), ...i };
    }
    Union(e, i = {}) {
      return a.TTemplateLiteral(e)
        ? k.Resolve(e)
    ...
    Unknown(e = {}) {
      return this.Create({ ...e, [o.Kind]: 'Unknown' });
    }
    Unsafe(e = {}) {
      return this.Create({ ...e, [o.Kind]: e[o.Kind] || 'Unsafe' });
    }
    Uppercase(e, i = {}) {
      return { ...Y.Map(P.Type(e), 'Uppercase'), ...i };
    }
  };
  ...
  var Fe = class extends le {
    ...
    Awaited(e, i = {}) {
      let u = (p) =>
        p.length > 0
          ...
          : p;
      return a.TIntersect(e)
        ? o.Type.Intersect(u(e.allOf))
        : a.TUnion(e)
          ? o.Type.Union(u(e.anyOf))
          : a.TPromise(e)
            ? this.Awaited(e.item)
            : P.Type(e, i);
    }
    BigInt(e = {}) {
      return this.Create({ ...e, [o.Kind]: 'BigInt', type: 'bigint' });
    }
    ...
    InstanceType(e, i = {}) {
      return P.Type(e.returns, i);
    }
    Iterator(e, i = {}) {
      return this.Create({ ...i, [o.Kind]: 'Iterator', type: 'Iterator', items: P.Type(e) });
    }
    Parameters(e, i = {}) {
      return this.Tuple(e.parameters, { ...i });
    }
    ...
    Symbol(e) {
      return this.Create({ ...e, [o.Kind]: 'Symbol', type: 'symbol' });
    }
    Undefined(e = {}) {
      return this.Create({ ...e, [o.Kind]: 'Undefined', type: 'undefined' });
    }
    Uint8Array(e = {}) {
      return this.Create({ ...e, [o.Kind]: 'Uint8Array', type: 'Uint8Array' });
    }
    Void(e = {}) {
      return this.Create({ ...e, [o.Kind]: 'Void', type: 'void' });
    }
  };
  o.JavaScriptTypeBuilder = Fe;
  o.JsonType = new le();
  o.Type = new Fe();
});
var ce = jn(he(), 1),
          ...
          for (let c in l)
            c !== '$schema' &&
              (i[c]
                ? (i[c].variants = [
                    ...i[c].variants,
                    ..._e({ key: c, value: l[c], languageTag: u }).variants,
                  ])
                : (i[c] = _e({ key: c, value: l[c], languageTag: u })));
        } catch (p) {
...
function Bn(s) {
  ...
  for (let l of p) {
    ...
    !c ||
      !T ||
      (T === '*'
        ? i.push({ type: 'catchall-match', key: c })
        : i.push({ type: 'literal-match', key: c, value: T }),
      u.push({ type: 'variable-reference', name: c }));
  }
...
function Mn(s) {
  ...
  if (s.startsWith('local')) {
    ...
    return {
      ...
      value: {
        type: 'expression',
        arg: { type: 'variable-reference', name: u.trim() },
        annotation: p ? { type: 'function-reference', name: p.trim(), options: c ?? [] } : void 0,
      },
    };
  }
  ...
  for (let l in u)
    p.push({
      ...
      content: new TextEncoder().encode(
        JSON.stringify(
          Ye({ $schema: 'https://inlang.com/schema/inlang-message-format', ...u[l] }),
          void 0,
          '	',
        ),
      ),
  ...
  return [
    {
      declarations: s.declarations
        .sort((p, l) => p.name.localeCompare(l.name))
        .map(zn)
        .sort(),
      selectors: e.selectors.map((p) => p.name).sort(),
      match: Object.fromEntries(u),
    },
  ];
}
function cn(s) {
...
function Vn(s) {
  return s
    ...
    .map((i) => (i.type === 'literal-match' ? `${i.key}=${i.value}` : `${i.key}=*`))
    .join(', ');
}
function zn(s) {
  if (s.type === 'input-variable') return `input ${s.name}`;
  if (s.type === 'local-variable') {
    let e = '';
    if (
      (s.value.arg.type === 'variable-reference'
        ? (e = `local ${s.name} = ${s.value.arg.name}`)
        : s.value.arg.type === 'literal' && (e = `local ${s.name} = "${s.value.arg.value}"`),
