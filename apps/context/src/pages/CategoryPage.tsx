...
export default function CategoryPage() {
  ...
  const category = createMemo(() =>
    params.categoryId ? getCategoryById(params.categoryId) : undefined,
  );
  const entries = createMemo(() =>
    params.categoryId ? getEntriesByCategory(params.categoryId) : [],
  );
    ...
    <Layout>
      ...
      >
        ...
        <div class="mb-6">
          ...
          <p style={{ color: 'var(--text-secondary)' }}>{category()?.description[locale()]}</p>
