    ...
    <Layout>
            ...
            {(page) => (
              <li>
                <A
                  ...
                  class="block px-3 py-2 rounded-lg text-sm transition-colors hover:bg-[var(--bg-tertiary)]"
          ...
          <For each={categories}>
            {(category) => (
              <A
                ...
                class="flex items-center gap-3 p-4 rounded-xl transition-colors hover:bg-[var(--bg-tertiary)]"
                style={{
      ...
      >
        ...
        <a
          ...
          class="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm transition-colors hover:bg-[var(--bg-tertiary)]"
          style={{
