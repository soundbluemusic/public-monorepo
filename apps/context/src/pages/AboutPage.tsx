...
export default function AboutPage() {
  ...
  const getContent = () => {
    if (locale() === "ko") {
      return {
        title: "Context 소개",
        description: "한국어를 배우는 학습자들을 위한 의미 사전입니다. 한국어 단어의 의미를 영어로 자세히 설명합니다.",
        stats: `${categories.length}개 카테고리 · ${meaningEntries.length}개 단어 · 2개 언어`,
      };
    }
    return {
      title: "About Context",
      description: "A meaning dictionary for Korean learners. Korean words explained in detail in English.",
