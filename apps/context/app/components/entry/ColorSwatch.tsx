...
const CSS_COLORS: Record<string, string> = colorCodes.css;
const CUSTOM_COLORS: Record<string, string> = colorCodes.custom;

/**
 * 영어 색상명으로 hex 코드 조회
 * @param englishName - 영어 색상명 (예: "Red", "LightGray")
 * @returns hex 코드 또는 null
 */
export function getColorCodeByName(englishName: string): string | null {
  ...
  // CamelCase를 소문자로 변환 (예: LightGray -> lightgray)
