...
/**
 * Entry 페이지 - 한국어 버전 (R2 SSG 빌드용)
 *
 * BUILD_TARGET=r2 빌드에서만 사용됨
 * loader 포함 → prerender 시 완전한 HTML 생성 → R2 업로드 → 즉시 서빙
 */

/**
 * loader: SSG 빌드 시 실행
 * 빌드 시점에 데이터를 가져와 HTML에 포함
 */
