...
const webApis: WebAPI[] = [
  ...
  },
  {
    ...
    descriptionKo: '사용자 상호작용 및 이벤트 처리',
    category: 'DOM',
    support: '99%',
    mdnUrl: 'https://developer.mozilla.org/en-US/docs/Web/API/Event',
  },
  {
  ...
  {
    name: 'ResizeObserver',
    description: 'Watch element size changes',
    descriptionKo: '엘리먼트 크기 변경 감지',
    category: 'DOM',
    support: '96%',
  ...
  {
    name: 'XMLHttpRequest',
    description: 'Classic AJAX requests',
    descriptionKo: '클래식 AJAX 요청',
    category: 'Network',
    support: '99%',
    mdnUrl: 'https://developer.mozilla.org/en-US/docs/Web/API/XMLHttpRequest',
  },
  {
    name: 'WebSocket',
  ...
  {
    name: 'Beacon',
    description: 'Send analytics data reliably',
    descriptionKo: '분석 데이터 안정적 전송',
    category: 'Network',
    support: '96%',
  ...
  {
    name: 'Cache API',
    description: 'Store request/response pairs',
    descriptionKo: '요청/응답 쌍 저장',
    category: 'Storage',
    support: '95%',
  ...
  {
    name: 'WebGPU',
    description: 'Next-gen GPU access',
    descriptionKo: '차세대 GPU 접근',
    category: 'Graphics',
    support: '75%',
  ...
  },
  {
    ...
    category: 'Media',
    support: '96%',
    mdnUrl: 'https://developer.mozilla.org/en-US/docs/Web/API/MediaStream',
  },
  {
    name: 'Speech Synthesis',
    description: 'Text-to-speech',
    descriptionKo: '텍스트 음성 변환',
    category: 'Media',
    support: '95%',
  ...
  {
    name: 'Web Workers',
    description: 'Background thread processing',
    descriptionKo: '백그라운드 스레드 처리',
    category: 'Workers',
    support: '98%',
  ...
  {
    name: 'Shared Workers',
    description: 'Share state across tabs',
    descriptionKo: '탭 간 상태 공유',
    category: 'Workers',
    support: '75%',
    mdnUrl: 'https://developer.mozilla.org/en-US/docs/Web/API/SharedWorker',
  },
  ...
  {
    name: 'History',
    description: 'Browser navigation control',
    descriptionKo: '브라우저 내비게이션 제어',
    category: 'Utilities',
    support: '99%',
  ...
  },
  {
    ...
    descriptionKo: 'URL 파싱 및 조작',
    category: 'Utilities',
    support: '99%',
    mdnUrl: 'https://developer.mozilla.org/en-US/docs/Web/API/URL',
  },
  {
    name: 'FormData',
    description: 'Form data handling',
    descriptionKo: '폼 데이터 처리',
    category: 'Utilities',
    support: '99%',
  ...
  return (
    <>
      ...
      <Meta
        name="description"
        content={
          locale() === 'ko' ? '브라우저 내장 웹표준 API 목록' : 'Browser built-in Web Standard APIs'
        }
      />
                    ...
                    {(api) => (
                      ...
                      >
                        <div class="flex items-start justify-between mb-2">
                          ...
                          <span class="badge-mit">{api.support}</span>
                        </div>
