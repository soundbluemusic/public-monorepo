...
const webApis: Record<string, WebApiDetail> = {
  fetch: {
    name: 'Fetch API',
    description:
      'Modern interface for making HTTP requests, replacing XMLHttpRequest with a cleaner, Promise-based approach.',
    descriptionKo:
      'XMLHttpRequest를 대체하는 현대적인 HTTP 요청 인터페이스로, Promise 기반의 깔끔한 API를 제공합니다.',
    category: 'Network',
    support: '97%',
  ...
  localstorage: {
    name: 'localStorage',
    description:
      'Web Storage API that allows storing key-value pairs in the browser with no expiration time.',
...
socket.send('Hello Server!');`,
  ...
  canvas: {
    ...
    descriptionKo:
      'JavaScript와 HTML <canvas> 요소를 통해 그래픽을 그릴 수 있는 수단을 제공합니다.',
    category: 'Graphics',
    support: '99%',
            ...
            <DocsLayout>
              <div class="text-center py-16">
                ...
                <p class="text-slate-600 dark:text-slate-400 mb-6">
                  {isKo()
                    ? '요청하신 API 정보가 없습니다.'
                    : 'The requested API information is not available.'}
                </p>
                <A
                  href="/web-api"
      ...
      >
        ...
        <DocsLayout>
          ...
          <nav class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-6">
            ...
            <span>/</span>
            <A href="/web-api" class="hover:text-primary-500">
              Web API
            </A>
            <span>/</span>
          ...
          <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-slate-900 dark:text-white mb-3">{api()?.name}</h1>
