...
const libraries: Record<string, LibraryDetail> = {
  react: {
    ...
    descriptionKo:
      '컴포넌트 기반 아키텍처로 사용자 인터페이스를 구축하기 위한 JavaScript 라이브러리입니다.',
    category: 'Frameworks',
    license: 'MIT',
  ...
  vue: {
    ...
    descriptionKo:
      '접근하기 쉬운 학습 곡선으로 사용자 인터페이스를 구축하기 위한 프로그레시브 JavaScript 프레임워크입니다.',
    category: 'Frameworks',
    license: 'MIT',
  ...
  'solid-js': {
    name: 'Solid.js',
    description:
      'Simple and performant reactivity for building user interfaces with fine-grained reactivity.',
    descriptionKo:
      '세밀한 반응성으로 사용자 인터페이스를 구축하기 위한 간단하고 성능 좋은 반응형 라이브러리입니다.',
    category: 'Frameworks',
    license: 'MIT',
  ...
  tailwindcss: {
    ...
    descriptionKo:
      '커스텀 사용자 인터페이스를 빠르게 구축하기 위한 유틸리티 우선 CSS 프레임워크입니다.',
    category: 'Styling',
    license: 'MIT',
