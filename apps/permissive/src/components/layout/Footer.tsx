        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-slate-500 dark:text-slate-400">
          <div class="flex items-center gap-2">
            ...
            <a
              ...
              class="font-medium hover:text-slate-700 dark:hover:text-slate-300 transition-colors"
            >
              soundbluemusic
            </a>
          </div>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="flex items-center gap-2 hover:text-slate-700 dark:hover:text-slate-300 transition-colors"
          >
