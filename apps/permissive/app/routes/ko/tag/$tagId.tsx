/**
 * @fileoverview 태그별 라이브러리 목록 페이지 (한국어)
 */
    ...
    <DocsLayout>
      <div className="max-w-4xl mx-auto">
        ...
        <header className="mb-8">
          ...
          <p className="text-(--text-secondary)">{libraries.length}개의 라이브러리</p>
        </header>
        ...
        {/* Library List */}
        <section>
          <h2 className="text-xl font-semibold text-(--text-primary) mb-4">라이브러리</h2>
