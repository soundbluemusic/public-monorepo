...
| 기술 | 버전 | 비고 |
| ---- | ---- | ---- |
| **React** | ^19.2.8 | React 19 Stable |
| **TanStack Start** | ^1.168.32 | SSR 프레임워크 |
| **TanStack Router** | ^1.170.18 | 파일 기반 라우팅 |
| **Vite** | ^8.1.5 | Rolldown 번들러 (7x 빠른 빌드), Stable |
| **TypeScript** | ^7.0.2 | 타입 체크 |
| **Tailwind CSS** | ^4.3.3 | v4 사용 중 |
| **Zod** | ^4.4.3 | 모든 워크스페이스 동일 |
| **Zustand** | ^5.0.14 | 상태 관리 |
| **Cloudflare Wrangler** | ^4.114.0 | Workers 배포 |
| **@cloudflare/vite-plugin** | ^1.47.0 | Vite 통합 |
| **@cloudflare/workers-types** | ^5.20260726.1 | Workers TypeScript 타입 |
| **@inlang/paraglide-js** | ^2.23.0 | i18n 컴파일러 |
