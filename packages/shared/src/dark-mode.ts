 ...
 * - Option A: innerHTML replacement (DARK_MODE_TOGGLE_SCRIPT)
 * - Option B: CSS mask-image (DARK_MODE_ICONS_CSS + DARK_MODE_TOGGLE_SCRIPT_CSS)
 * - Option C: Both icons rendered, CSS toggle (DARK_MODE_DUAL_ICONS_CSS)
 */
 ...
 * Uses stroke="#fff" for proper masking
 */
 ...
 * Include in a <style> tag in the <head>.
 *
 * @example
 * ```tsx
 * <style dangerouslySetInnerHTML={{ __html: DARK_MODE_ICONS_CSS }} />
 * ```
 */
 ...
 * Toggles icon classes instead of replacing innerHTML.
 */
 ...
 *
 * This approach requires no JavaScript for icon switching.
 *
 * @example
 * Button markup:
 * ```html
 ...
 * Only handles theme toggling - icon visibility is pure CSS.
 */
