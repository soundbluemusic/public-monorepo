...
export function preloadLink(
  ...
  return { rel: 'preload', href, as, ...options };
}
...
export function preloadScript(href: string): PreloadLinkDescriptor {
  return { rel: 'preload', href, as: 'script' };
}
...
export function preconnect(
  ...
  return { rel: 'preconnect', href, ...options };
}
...
/** Common preconnects for popular services */
